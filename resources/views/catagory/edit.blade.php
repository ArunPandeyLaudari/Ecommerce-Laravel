...
@section('content')
    ...
    <form action="{{ route('catagory.update', $catagory->id) }}" class="mt-5" method="POST">
        ...
        <div class="flex justify-center gap-4 mt-4">
            <input type="submit" value="Update Catagory" class="px-5 py-3 text-white bg-blue-900 rounded cursor-pointer">
