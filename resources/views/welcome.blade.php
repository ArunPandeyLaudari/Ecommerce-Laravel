...
@section('title')
    Home | LICT E-commerce
@endsection

@section('content')
    <!-- Latest Products Section -->
    <div class="px-4 py-12 mx-auto max-w-7xl">
        <h2 class="pl-4 text-4xl font-bold text-blue-900 border-l-4 border-yellow-500 lg:text-5xl">Latest Products</h2>
        <p class="mt-2 text-lg text-gray-600 lg:text-xl">Discover our premium selection of the latest tech</p>
